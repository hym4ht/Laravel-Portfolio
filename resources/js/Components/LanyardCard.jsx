...
const GLTF_PATH = import.meta.env.BASE_URL + 'assets/models/card.glb';
const TEXTURE_PATH = import.meta.env.BASE_URL + 'assets/textures/lanyard.png';
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  const cardTexture = useTexture(import.meta.env.BASE_URL + 'assets/textures/lanyardcard.png');
