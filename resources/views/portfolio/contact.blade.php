      ...
      <div class="-mx-4 flex flex-wrap lg:justify-between">
        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div class="mb-12 max-w-[570px] lg:mb-0">
            ...
            <h2
              class="mb-6 text-[32px] font-bold uppercase text-whiite sm:text-[40px] lg:text-[36px] xl:text-[40px] dark:text-white">
              GET IN TOUCH WITH US
            </h2>
            <p class="mb-9 text-base leading-relaxed text-body-color dark:text-white-6">
            ...
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full">
                <h4 class="mb-1 text-xl font-bold text-white dark:text-white">
                  Our Location
                </h4>
                <p class="text-base text-body-color dark:text-white-6">
            ...
            <form>
              <div class="mb-6">
                <input type="text" placeholder="Your Name"
                  class="w-full rounded-sm border border-stroke px-[14px] py-3 text-base text-body-color outline-hidden focus:border-primary dark:border-dark-3 dark:bg-dark dark:text-white-6" />
              </div>
              <div class="mb-6">
              ...
              <div class="mb-6">
                <textarea rows="6" placeholder="Your Message"
                  class="w-full resize-none rounded-sm border border-stroke px-[14px] py-3 text-base text-body-color outline-hidden focus:border-primary dark:border-dark-3 dark:bg-dark dark:text-white-6"></textarea>
              </div>
              <div>
                <button type="submit"
                  class="w-full rounded-sm border border-primary bg-primary p-3 text-white transition hover:bg-primary/90">
                  Send Message
                </button>
              </div>
            </form>
